/* SciVerse API
   ...
   Modified to be AMD compliant by Robert Berry <robert.berry@liverpool.ac.uk>
*/
...
define(function () {
    ...
    return {
        sciverseInterface: sciverseInterface,
        sciverseDebug: sciverseDebug,
        sciverseListRenderer: sciverseListRenderer,
        sciverseBackend: sciverseBackend,
        inflight: inflight,
        searchObj: searchObj,
        sciverse: sciverse,
        debug: debug
